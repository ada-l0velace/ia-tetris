...
(format t "---------------------~c" #\linefeed)
(format t "---------------------~c" #\linefeed)
(executa-jogadas (problema-estado-inicial p1) (procura-A* p1 #' heuristicas))
(format t "---------------------~c" #\linefeed)
(format t "---------------------~c" #\linefeed)
(format t "-----Procura-best----~c" #\linefeed)
(format t "---------------------~c" #\linefeed)
(format t "---------------------~c" #\linefeed)
(executa-jogadas (problema-estado-inicial p1) (procura-best (estado-tabuleiro (problema-estado-inicial p1)) (estado-pecas-por-colocar (problema-estado-inicial p1))))
